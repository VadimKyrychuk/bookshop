...
class Seller(models.Model):
    ...
    phone = models.CharField(max_length=20, blank=False, unique=True, verbose_name = 'Номер телефона')
    email = models.EmailField(blank=True, verbose_name = 'Email')
    position = models.CharField(max_length=64, blank=False, default='Trainee', choices=POSITION_LIST, verbose_name = 'Должность')
...
class Book(models.Model):
    ...
    img = models.ImageField(upload_to='books_img/%Y/%m/%d', blank=True, default='media/img.png', verbose_name = 'Картинка')
